...
export async function GET(request: NextRequest) {
  ...
  try {
    ...
    const sslCommerzData = {
      ...
      success_url: `${baseUrl}/api/payment/success?donationId=${donationId}`,
      fail_url: `${baseUrl}/api/payment/fail?donationId=${donationId}`,
      cancel_url: `${baseUrl}/api/payment/cancel?donationId=${donationId}`,
